            ...
            <div class="modal-body">
                <form name="commodity_edit">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="brand_edit">Bahan</label>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="commodity_location_id_edit">Ruangan</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="unit_edit">Satuan</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="vendor_edit">Nama vendor</label>
                                <input type="text" class="form-control" id="vendor_edit" >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
